  ...
  <div>
    ...
    <div class="container" style="padding-top:80px;">
      <div class="col-md-12 mt-5 mb-5">
        ...
        <p>
          Welcome to http://sendhive.io. The http://sendhive.io website (the
          "Site") is comprised of various web pages operated by SendHive ("IP
          Oven"). http://sendhive.io is offered to you conditioned on your
          acceptance without modification of the terms, conditions, and notices
          contained herein (the "Terms"). Your use of http://sendhive.io
          constitutes your agreement to all such Terms. Please read these terms
          carefully, and keep a copy of them for your reference.
        </p>

        <p>http://sendhive.io is a digital services website.</p>

        <p>
          SendHive is intended to increase domain and ip reputation on SMTP and
          MTA servers. We do NOT guarantee results due to our limitation on your
          Email Server. For example, if you knowingly or unknowingly send spam
          from your server while we are rendering our services, your actions
          will undo our services. In ideal circumstances our services are
          effective, e.g.) No emails are going out of your server, except the
          ones we are sending. Your mail server is not blacklisted (publicly of
          privately).
        </p>
        ...
        <p>
          Visiting http://sendhive.io or sending emails to SendHive constitutes
        ...
        <p>
          ...
          entity. You acknowledge that SendHive is not responsible for third
          party access to your account that results from theft or
          misappropriation of your account. SendHive and its associates reserve
          the right to refuse or cancel service, terminate accounts, or remove
          or edit content in our sole discretion.
        </p>

        <p>
          SendHive does not knowingly collect, either online or offline,
          personal information from persons under the age of thirteen. If you
          are under 18, you may use http://sendhive.io only with permission of a
          parent or guardian.
        </p>

        <h3 class="mt-5">Cancellation/Refund Policy</h3>
        <p>
          Subscriptions my be cancelled at any time, however there will be no
          refunds. Upon cancellation, services are rendered for the duration of
          the billing cycle and subscriptions are cancelled at the start of the
        ...
        <p>
          http://sendhive.io may contain links to other websites ("Linked
          Sites"). The Linked Sites are not under the control of SendHive and IP
          Oven is not responsible for the contents of any Linked Site, including
          without limitation any link contained in a Linked Site, or any changes
          or updates to a Linked Site. SendHive is providing these links to you
          only as a convenience, and the inclusion of any link does not imply
          endorsement by SendHive of the site or any association with its
          operators.
        </p>

        <p>
          Certain services made available via http://sendhive.io are delivered
          by third party sites and organizations. By using any product, service
          or functionality originating from the http://sendhive.io domain, you
          hereby acknowledge and consent that SendHive may share such
          information and data with any third party with whom SendHive has a
          contractual relationship to provide the requested product, service or
          functionality on behalf of http://sendhive.io users and customers.
        </p>
        ...
        <p>
          ...
          to access and use http://sendhive.io strictly in accordance with these
          terms of use. As a condition of your use of the Site, you warrant to
          SendHive that you will not use the Site for any purpose that is
        ...
        <p>
          ...
          used on the Site, is the property of SendHive or its suppliers and
        ...
        <p>
          ...
          exploit any of the content, in whole or in part, found on the Site. IP
          Oven content is not for resale. Your use of the Site does not entitle
          ...
          content without the express written permission of SendHive and the
          ...
          express or implied, to the intellectual property of SendHive or our
          licensors except as expressly authorized by these Terms.
        </p>

        <h3 class="mt-5">International Users</h3>

        <p>
          The Service is controlled, operated and administered by SendHive from
          ...
          laws. You agree that you will not use the SendHive Content accessed
          through http://sendhive.io in any country or in any manner prohibited
        ...
        <p>
          You agree to indemnify, defend and hold harmless SendHive, its
          ...
          rules or regulations. SendHive reserves the right, at its own cost, to
          ...
          cooperate with SendHive in asserting any available defenses.
        </p>

        <h3 class="mt-5">Arbitration</h3>
        <p>
        ...
        <h3 class="mt-5">Class Action Waiver</h3>
        <p>
        ...
        <h3 class="mt-5">Liability disclaimer</h3>
        <p>
          THE INFORMATION, SOFTWARE, PRODUCTS, AND SERVICES INCLUDED IN OR
          AVAILABLE THROUGH THE SITE MAY INCLUDE INACCURACIES OR TYPOGRAPHICAL
          ERRORS. CHANGES ARE PERIODICALLY ADDED TO THE INFORMATION HEREIN. IP
          OVEN AND/OR ITS SUPPLIERS MAY MAKE IMPROVEMENTS AND/OR CHANGES IN THE
          SITE AT ANY TIME.
        </p>

        <p>
          SendHive AND/OR ITS SUPPLIERS MAKE NO REPRESENTATIONS ABOUT THE
          ...
          CONDITION OF ANY KIND. SendHive AND/OR ITS SUPPLIERS HEREBY DISCLAIM
        ...
        <p>
          ...
          SendHive AND/OR ITS SUPPLIERS BE LIABLE FOR ANY DIRECT, INDIRECT,
          ...
          STRICT LIABILITY OR OTHERWISE, EVEN IF SendHive OR ANY OF ITS
        ...
        <h3 class="mt-5">Termination/access restriction</h3>
        <p>
          SendHive reserves the right, in its sole discretion, to terminate your
          ...
          agreement is governed by the laws of the State of Pennsylvania and you
          hereby consent to the exclusive jurisdiction and venue of courts in
          Pennsylvania in all disputes arising out of or relating to the use of
        ...
        <p>
          ...
          relationship exists between you and SendHive as a result of this
          agreement or use of the Site. SendHive's performance of this agreement
          is subject to existing laws and legal process, and nothing contained
          in this agreement is in derogation of SendHive's right to comply with
          ...
          gathered by SendHive with respect to such use. If any part of this
        ...
        <p>
          ...
          entire agreement between the user and SendHive with respect to the
          ...
          SendHive with respect to the Site. A printed version of this agreement
        ...
        <h3 class="mt-5">Changes to Terms</h3>
        <p>
          SendHive reserves the right, in its sole discretion, to change the
          Terms under which http://sendhive.io is offered. The most current
          version of the Terms will supersede all previous versions. SendHive
        ...
        <p>
          SendHive welcomes your questions or comments regarding this Statement
          of Privacy. If you believe that SendHive has not adhered to this
          Statement, please contact SendHive at:
        </p>

        <p>
          <strong>SendHive</strong><br />
          <strong>Address:</strong> 5 Cypress Point Dr. Mountain View, CA 94043
          USA<br />
          <strong>Email:</strong> support@sendhive.io
          <br />
          Effective as of April 17, 2021
        </p>
      </div>
    </div>
    <Footer />
